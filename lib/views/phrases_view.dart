...
class PhrasesView extends StatelessWidget {
  ...
  final List<PhrasesModel> phrases = const [
    ...
    PhrasesModel(title: 'Doko ni iku no', subtitle: 'Where are you going?',
        sound: 'sounds/phrases/where_are_you_going.wav'),
    PhrasesModel(title: 'Namae wa nandesu ka', subtitle: 'What is your name?',
    ...
    PhrasesModel(title: 'Kimsau ka', subtitle: 'Are you coming?',
